...
Copyright
    ...
    gen_c_mod is distributed in the hope that it will be useful, but
...
htmlhelp_basename: str = 'gen_c_moddoc'
latex_elements: Dict[Any, Any] = {}
latex_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_c_mod.tex', 'gen_c_mod Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_c_mod', 'gen_c_mod Documentation', [author], 1
)]
texinfo_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_c_mod', 'gen_c_mod Documentation', author, 'gen_c_mod',
